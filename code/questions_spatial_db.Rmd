...
- How to set up a good workflow between PostGIS and GRASS?

- First a workflow to upload vector data in PostGIS taking into account:  
    - special characters
    - a safest structure for the tables in PostGIS (as suggested in PostGIS in action book)