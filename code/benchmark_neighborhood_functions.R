#' ---
#' title: "Testing differences in results and time between neighborhood analysis in R and GRASS (r.neighbors and r.resamp.filter)"
...
#' From the plot, the results seem quite similar. Indeed, the mean, median, and 1st/4th quantiles are close to each
#' other. However, they differ locally in their values, differences of up to .1 (for a quantity in the interval [0, 1]),
#' in this case with average `as.numeric(global(g1_1[[1]], "mean"))`. Most probably this is due to different algorithms for
...
#' Or even bigger - let's use 10,000m (or 199 pixels).
...
#'---------------------------
#' ## Test4: edge effects for neighborhood analysis
#' 