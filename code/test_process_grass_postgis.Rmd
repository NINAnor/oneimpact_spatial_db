...
layer_use <- paste("sam_env", "public_roads_sw_test", sep = ".")

execGRASS("v.in.ogr", input = "PG:host=gisdata-db.nina.no user=bernardo.brandao password=LolaGalssauro87 dbname=gisdata",
          layer="AdministrativeUnits.Fenoscandia_Country_polygon", output = "test_fenos_polygon", flags = "overwrite")
...
execGRASS("v.in.ogr", input = str_con, layer = layer_use, 
          output = "public_roads_sw_test", flags = "overwrite")
